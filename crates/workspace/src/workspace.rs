...
impl Workspace {
    ...
    pub fn start_following(
        ...
        // Following is disabled without call functionality
        None
    }
    ...
    pub fn unfollow(
        ...
        // Unfollowing is disabled without call functionality
    ...
    fn active_item_for_peer(
        ...
        // Disabled without call functionality
        None
    }
...
fn leader_border_for_pane(
    ...
    let mut leader_color = match leader_id {
        CollaboratorId::PeerId(_) => {
            // Without call functionality, use a default color
            cx.theme().players().color_for_participant(0).cursor
        }
...
async fn join_channel_internal(
    ...
    // Channel functionality is disabled without call support
    Ok(false)
}
...
/*  Orphaned code from removed channel functionality
            if result.is_ok() {
                cx.update(|cx| {
